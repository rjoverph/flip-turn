...
/**
 * Build a page with the AboutEdit  form
 ...
 *
 */
class AboutEditPage extends FlipTurnLayoutPage
{
    function content_block()
    {
	    ...
	    //  Create the form
        $form = new FlipTurnEditAboutPageForm("About Edit", null, '100%') ;
...
$page = new AboutEditPage("About Edit") ;
print $page->render() ;
?>
