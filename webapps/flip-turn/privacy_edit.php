...
/**
 * Build a page with the PrivacyEdit  form
 ...
 *
 */
class PrivacyEditPage extends FlipTurnLayoutPage
{
    function content_block()
    {
	    ...
	    //  Create the form
        $form = new FlipTurnEditPrivacyPageForm("Privacy Edit", null, '100%') ;
...
$page = new PrivacyEditPage("Privacy Edit") ;
print $page->render() ;
?>
