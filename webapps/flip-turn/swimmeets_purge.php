...
/**
 * Build a page with the SwimMeet Purge form
 ...
 *
 */
class SwimMeetPurgePage extends FlipTurnLayoutPage
{
    function content_block()
    {
	    ...
	    //  Create the form
        $form = new SwimMeetsPurgeForm("Purge Swim Meets", null, 600) ;
...
$page = new SwimMeetPurgePage("Swim Meet Purge") ;
print $page->render() ;
?>
