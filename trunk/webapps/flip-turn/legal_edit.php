...
/**
 * Build a page with the LegalEdit  form
 ...
 *
 */
class LegalEditPage extends FlipTurnLayoutPage
{
    function content_block()
    {
	    ...
	    //  Create the form
        $form = new FlipTurnEditLegalPageForm("Legal Edit", null, '100%') ;
...
$page = new LegalEditPage("Legal Edit") ;
print $page->render() ;
?>
