...
include_once("results.forms.class.php") ;

/**
 * Build a page with the Results Purge form
 ...
 *
 */
class ResultsPurgePage extends FlipTurnLayoutPage
{
    function content_block()
    {
	    ...
	    //  Create the form
        $form = new ResultsPurgeForm("Purge Results", $_SERVER['PHP_SELF'], 600) ;
...
$page = new ResultsPurgePage("Results Purge") ;
print $page->render() ;
?>
