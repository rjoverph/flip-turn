 ...
 *
 *
 * $Id: form4.php 2779 2007-05-18 17:43:03Z hemna $
 *
...
class FECountryListMaster extends FEListBoxMaster {
    ...
    var $_countries = array("Select Country",
                            ...
                            "Kenya" ,
                            "United Kingdom" ,
                            "United States of America" => array('code' => 'United States of America',
                                                                "slave" => array("Select State" => "",
                                                                                 "Alabama" => "Alabama",
...
class Form4Page extends MyLayoutPage {
    ...
    function content_block() {
        ...
        return new FormProcessor( new MasterSlaveForm());
    }
}
...
class MasterSlaveForm extends FormContent {
    ...
    function form() {
        ...
        $table->add_row(phphtmllib::_HTML_SPACE, $this->get_button("Submit"));
