 ...
 *
 * $Id: form3.php 2779 2007-05-18 17:43:03Z hemna $
 *
...
class Form3Page extends MyLayoutPage {
    ...
    function content_block() {
        ...
        return new FormProcessor(new SampleForm('form3.php'));
    }
}
...
class SampleForm extends FormContent { // {{{
    ...
    function form_init_elements() {
        ...
        $this->add_element(new FEButton("FEButton Label", FALSE, 'button-value'));
...
//        $this->add_element($file);
        ...
        $this->add_element(new FEMonthsListBox("FEMonths label", false));

        // FEYears($label, $required = TRUE, $width = NULL, $height = NULL, $min_year = 2000, $max_year = 2010) {
        $this->add_element(new FEYearsListBox("FEYears label", false, null, null, date('Y'), date('Y') + 10));

        // FEDays($label, $required = TRUE, $width = NULL, $height = NULL) {
        $this->add_element(new FEDaysListBox("FEDays label", false));

        // set the locale to dutch
        setlocale(LC_TIME, 'nl_NL');

        // TODO: document this
        $date_element = new FEDateListBox("FEDate label", false, null, null, 'Fdy', 1970, 1975);
...
//        $date_element->set_text_format("%04d-%02d-%02d");
        ...
        $this->add_element(new FEFloat("FENumberFloat label", false, "200px"));
        $this->add_element(new FEFloat("FENumberFloat label", false, "200px"));
        ...
        // Same constructor as FEText
        $this->add_element(new FEPrice("FENumberPrice label", false, "200px"));
        ...
        $this->add_element(new FEUnitedStatesListBox("FEUnitedStates label", false));
    ...
    function form_init_buttons() {
        $this->add_button(new FESubmitButton("FESubmitButton label"));
    ...
    function form() {
        ...
        $table = TABLEtag::factory("100%",0,0,2);
