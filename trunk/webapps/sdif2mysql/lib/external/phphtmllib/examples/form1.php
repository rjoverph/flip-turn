...
class Form1Page extends MyLayoutPage {
    ...
    function content_block() {
        ...
        return new DIVtag(array('style' => 'width:600px'),
                          new FormProcessor( new AccountForm()));
    }
}
...
class AccountForm extends FormContent {
    ...
    function form_init_elements() {
        ...
        $password_check = new FECheckBox("Save Password");
        $this->add_element($password_check);
    ...
    /**
     * Initialize the submit buttons used in this form
     *
     */
    function form_init_buttons() {
        $this->add_button(new FESubmitButton("Submit"));
        $this->add_button(new FESubmitButton("Save"));
        $this->add_button(new FESubmitButton("OK"));
    }
     ...
     */
    function form() {
        $table = TABLEtag::factory(600,0,4);
        ...
        $table->add_row("&nbsp;",
                        $this->element_form("Save Password"));

        $table->add_row(phphtmllib::_HTML_SPACE,
                        Container::factory($this->get_button("Submit"),
                                           phphtmllib::_HTML_SPACE,
                                           $this->get_button("Save"),
                                           phphtmllib::_HTML_SPACE,
                                           $this->get_button("OK")));
