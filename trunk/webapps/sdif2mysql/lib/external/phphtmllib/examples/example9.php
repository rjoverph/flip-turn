 ...
 * methods.
 *
 * $Id: example9.php 2778 2007-05-18 17:17:06Z hemna $
 *
...
for ($i = 0; $i<20; $i++) {
    ...
    $table->add_row(Btag::factory(rand(1,1000)), rand(2000,3000), rand(3000,4000));
}
